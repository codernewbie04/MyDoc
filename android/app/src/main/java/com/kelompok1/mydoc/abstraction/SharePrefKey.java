package com.kelompok1.mydoc.abstraction;

public class SharePrefKey {
    public static final String MYDOC_PREF = "SharePrefKey.MyDoc";
    public static final String ACCESS_TOKEN = "SharePrefKey.AccessToken";
    //Detail of User Data
