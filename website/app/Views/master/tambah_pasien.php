            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <h4 class="header-title text-center text-uppercase">Tambah Akun Pasien</h4>
                        ...
                        <?=form_error(session('success'), '<div class="alert alert-success" role="alert">', '</div>'); ?>
                            <form method="post" action="<?= base_url('admin/pasien/add'); ?>">
                                <div class="form-group">
                                    <label for="supplier" class="col-form-label">Nama Lengkap</label>
